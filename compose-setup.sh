...
echo "compose-setup: wrote .env"
echo "compose-setup: installed Command Code key as ./secrets/command-code-goat"
echo "compose-setup: prepared ./run/hquota with mode 0700"
